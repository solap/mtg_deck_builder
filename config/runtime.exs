...
#
#     PHX_SERVER=true bin/mtg_deck_builder start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :mtg_deck_builder, MtgDeckBuilderWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :mtg_deck_builder, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
